...
class BreastfeedingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create breastfeeding" do
    assert_difference('Breastfeeding.count') do
      post breastfeedings_url, params: { breastfeeding: { amount: @breastfeeding.amount, baby_id: @breastfeeding.baby_id, time: @breastfeeding.time } }
    end
  ...
  test "should update breastfeeding" do
    patch breastfeeding_url(@breastfeeding), params: { breastfeeding: { amount: @breastfeeding.amount, baby_id: @breastfeeding.baby_id, time: @breastfeeding.time } }
